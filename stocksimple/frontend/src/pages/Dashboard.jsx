    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <Link to="/add-product" className="bg-blue-600 hover:bg-blue-700 rounded-xl p-4 text-center transition">
                    <svg className="w-8 h-8 mx-auto text-white mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                    </svg>
                    <p className="text-white font-medium">Add Product</p>
                </Link>
                <Link to="/stock-update" className="bg-green-600 hover:bg-green-700 rounded-xl p-4 text-center transition">
                    <svg className="w-8 h-8 mx-auto text-white mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
                    </svg>
                    <p className="text-white font-medium">Update Stock</p>
                </Link>
                <Link to="/products" className="bg-purple-600 hover:bg-purple-700 rounded-xl p-4 text-center transition">
                    <svg className="w-8 h-8 mx-auto text-white mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                    </svg>
                    <p className="text-white font-medium">View Products</p>
                </Link>
                <Link to="/reports" className="bg-orange-600 hover:bg-orange-700 rounded-xl p-4 text-center transition">
                    <svg className="w-8 h-8 mx-auto text-white mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className={`text-3xl font-bold mt-2 ${lowStockAlerts.length > 0 ? 'text-orange-500' : 'text-green-500'}`}>
                                {lowStockAlerts.length}
                            </p>
                        </div>
                        <div className={`p-3 rounded-lg ${lowStockAlerts.length > 0 ? 'bg-orange-500/10' : 'bg-green-500/10'}`}>
                            <svg className={`w-8 h-8 ${lowStockAlerts.length > 0 ? 'text-orange-500' : 'text-green-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-white mt-2">{recentMovements.length}</p>
                        </div>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 mb-8">
                <div className="flex items-center justify-between mb-4">
                    ...
                    {lowStockAlerts.length > 0 && (
                        <Link to="/stock-update" className="text-blue-400 hover:text-blue-300 text-sm">
                            Update Stock →
                        </Link>
                    )}
                </div>
